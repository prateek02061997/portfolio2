...
def get_cv_prompt(job_description: str, cv_data: dict) -> str:
    return f"""You are an expert CV writer and ATS optimisation specialist.

Your job is to tailor Prateek's CV for the job description below while keeping the EXACT SAME FORMAT AND STRUCTURE as the original.

STRICT RULES:
1. Keep ALL 4 experience entries -- do not remove any jobs
2. Keep ALL projects from the list -- do NOT drop any. Reorder them so the most JD-relevant appear first, but every project must be present so the CV stays a complete two-page document.
3. Reorder skill items within each category to put JD-matching skills first
4. Write a 2-3 sentence summary that sounds natural and uses JD keywords
5. Lightly adjust bullet wording only to emphasise relevant keywords -- stay 100% truthful
6. Keep all 4 skill categories with their EXACT category names as listed below
7. Return ONLY valid JSON -- no markdown, no explanation, nothing else

Skill category names to use EXACTLY (do not change these):
- "Business Intelligence"
- "Data and Analytics"
- "Business Partnering"
- "Operations and Agile"

Each project must include "name", "role", and "url" fields.
Projects available:
- name: "Kiwi Budget Tours", role: "Founder and Insights Lead", url: "kiwibudgettours.com"
- name: "RAG Customer Support Assistant", role: "AI Automation Analyst", url: ""
- name: "Generative AI Business Process Automation", role: "AI Automation Analyst", url: "prateek02061997.github.io/Prateek-Portfolio"
- name: "Gilmours Workflow Analysis and Process Redesign", role: "Operational Analyst", url: "prateek02061997.github.io/Prateek-Portfolio"
- name: "Synlait Milk Supply Chain Optimisation", role: "Design Thinking Analyst", url: "prateek02061997.github.io/Prateek-Portfolio"
- name: "Genesis Energy Supply Chain Analysis", role: "Sustainability and Supply Chain Analyst", url: "prateek02061997.github.io/Prateek-Portfolio"
- name: "Fuel Prices and EV Demand in New Zealand", role: "Master's Thesis", url: "prateek02061997.github.io/Prateek-Portfolio"

Return this EXACT JSON structure:
{{
  "summary": "2-3 sentence tailored professional summary",
  "skills": {{
    "Business Intelligence": ["most relevant first", "..."],
    "Data and Analytics": ["most relevant first", "..."],
    "Business Partnering": ["most relevant first", "..."],
    "Operations and Agile": ["most relevant first", "..."]
  }},
  "projects": [
    {{
      "name": "Project Name",
  ...
  "education": [
    {{
      ...
      "period": "2024 to 2025",
      "note": "one line note about coursework or achievement"
    }}
  ]
}}
...
5. Write EXACTLY 4 paragraphs in first person, natural, human voice -- no cliches, no templates:
